...
const navLinks = (props) => {
  ...
  return (
    <header className='nav-bar'>
      <Link id='nav-logo-link' to='/'><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 viewBox="944 22 2978 749" >
        <path className="st0" d="M1833.7,341.3c0-74.4,54.2-126.3,152.8-126.3c60.1,0,109.3,19.2,136,38c3.8,2.7,10.6,9.2,6.5,21.3
        ...
        <path className="st1" d="M1008.4,450.7c-27.6,0.2-50.9-16.2-59.5-41.9c-0.3-1-0.6-1.9-0.9-2.9c-9.4-32.8,8.8-67.2,41.4-78.2l523.1-175.3
	...
	C1022.8,449.4,1015.6,450.6,1008.4,450.7L1008.4,450.7z"/>
        <path className="st2" d="M1095.6,707.9c-27.8,0.2-51.2-16-59.7-41.3c-0.3-1-0.6-1.9-0.9-2.9c-9.5-33.2,8.7-68,41.4-79l523.2-176.9
	...
	l-525.1,179.6C1110.6,706.6,1103.1,707.8,1095.6,707.9L1095.6,707.9z"/>
        <path className="st3" d="M1531,709.1c-27.8,0.3-52.6-17.4-61.5-43.8L1295,146.7l-0.9-2.9c-9.5-33.1,8.7-67.6,41.3-78.6
	...
	C1544.6,707.9,1537.8,709,1531,709.1L1531,709.1z"/>
        <path className="st4" d="M1271.5,796.4c-27.8,0.3-52.7-17.4-61.5-43.8L1035.4,234c-11.4-33.6,6.7-70,40.3-81.4c0,0,0.1,0,0.1,0
	...
	C1285,795.2,1278.3,796.3,1271.5,796.4L1271.5,796.4L1271.5,796.4z"/>
        <path className="st5" d="M1445,592.3l121.7-41.6l-39.8-118.2L1405,473.6L1445,592.3z"/>
        <path className="st6" d="M1185.9,680.9l121.7-41.6l-40.1-119.1l-121.9,41.2L1185.9,680.9z"/>
        <path className="st7" d="M1358.3,334.8l121.8-41.6l-39.3-116.8l-122,40.9L1358.3,334.8z"/>
        <path className="st8" d="M1099.2,423.3l121.8-41.6l-39.8-118.3l-122,40.9L1099.2,423.3z"/>
      </svg>
      </Link>
      {nav}
    </header>
